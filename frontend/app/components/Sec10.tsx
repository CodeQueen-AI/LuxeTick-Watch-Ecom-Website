...
export default function Collection() {
  return (
    <section className="py-16 md:py-20">
      ...
      {/* Heading */}
      <h1 className="text-center text-5xl sm:text-6xl md:text-7xl font-extralight mb-10 md:mb-12 allura">
        Collection
      </h1>

      {/* Grid */}
      <div className="w-[90%] md:w-[70%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 cursor-pointer">

        {/* First Column */}
        <div className="relative w-full aspect-square lg:h-[450px] bg-[url('/watch/w20.jpg')] bg-cover bg-center group">
          <Overlay name="Rado" />
        </div>

        {/* Second Column */}
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="relative w-full aspect-square lg:h-[215px] bg-[url('/watch/w21.jpg')] bg-cover bg-center group">
            <Overlay name="Tissot" />
          </div>
          <div className="relative w-full aspect-square lg:h-[215px] bg-[url('/watch/w22.jpg')] bg-cover bg-center group">
            <Overlay name="Cartier" />
          </div>
        </div>
        ...
        {/* Third Column */}
        <div className="flex flex-col gap-4 sm:gap-5">
          <div className="relative w-full aspect-square lg:h-[140px] bg-[url('/watch/w23.jpg')] bg-cover bg-center group">
            <Overlay name="Geneve" />
          </div>
          <div className="relative w-full aspect-square lg:h-[140px] bg-[url('/watch/w24.jpg')] bg-cover bg-center group">
            <Overlay name="Omega" />
          </div>
          <div className="relative w-full aspect-square lg:h-[140px] bg-[url('/watch/w25.jpg')] bg-cover bg-center group">
            <Overlay name="Fitron" />
          </div>
        </div>
      </div>
...
function Overlay({ name }: { name: string }) {
  return (
    <>
      <div className="absolute inset-0 bg-black/50 scale-x-0 origin-right transition-transform duration-700 group-hover:scale-x-100 group-hover:origin-left"></div>
      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-700">
        <span className="bg-[#e8cfa8] px-4 sm:px-6 py-2 sm:py-3 uppercase text-xs sm:text-sm text-white">
          {name}
        </span>
      </div>
    </>

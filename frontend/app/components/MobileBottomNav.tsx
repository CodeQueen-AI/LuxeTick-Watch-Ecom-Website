...
//     { href: "/contact", icon: <LuMessageSquareText />, badge: 0 },
//     { href: "/wishlist", icon: <GoHeart />, badge: wishlistItems.length },
//     { href: "/cart", icon: <BsCart3 />, badge: totalQuantity }, // ✅ FIXED
//   ];
...
// ) : (
//   <Link href="/signup">
//     <button className="ml-2 px-3 py-1 bg-black text-white text-sm rounded hover:bg-gray-800 transition">
//       SIGN UP
//     </button>
//   </Link>
// )}
...
//           {/* SIGN UP button (if no user) */}
//           {!user && (
//             <Link href="/signup">
//               <button className="px-2 py-1 bg-black text-white text-xs rounded hover:bg-gray-800 transition mr-2">
//                 SIGN UP
//               </button>
//             </Link>
//           )}
...
export default function MobileNavbar() {
  ...
  return (
    <>
      ...
      {/* {!user && (
        <div className="fixed top-0 right-0 z-50 md:hidden flex items-center p-2"> */}
          {/* <Link href="/signup">

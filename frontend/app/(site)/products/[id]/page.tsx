...
export default function ProductDetailPage() {
  ...
  return (
    <section className="poppins overflow-hidden">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 flex flex-col justify-between">
              ...
              <div className="w-full max-w-md mt-2 space-y-1">
                ...
                <div className="border-b py-2">
                  <button
                    ...
                    className="flex justify-between w-full text-lg font-serif transition-colors duration-300 hover:text-blue-600"
                  >
                    Product Details
                    <span
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              ...
              <button
                ...
                className="px-16 py-4 bg-black text-white border border-black transition-all duration-300 hover:bg-white hover:text-black hover:scale-105"
              >
                Add To Cart
              </button>
      ...
      {/* Toast */}
      {toastMessage && (
        <div className="fixed bottom-6 right-6 flex items-center gap-3 bg-white border shadow-xl px-5 py-3">

        ...
        <div className="flex flex-col lg:flex-row lg:w-4/5 mx-auto items-start">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 flex flex-col justify-between">
            <div>
              ...
              {/* Stock */}
              <fieldset className="border border-gray-300 rounded-lg px-3 py-2 mb-4 shadow-sm">
                <legend className="text-lg font-serif px-1">STOCK</legend>
                <p className={`text-sm mt-1 font-medium ${product.stock === 0 ? "text-red-500" : "text-green-600"}`}>
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              ...
              <button
                ...
                className={`px-16 py-4 border border-black transition-all duration-300 ${
                  product.stock === 0
                    ? "bg-gray-300 text-gray-700 cursor-not-allowed"
                    : "bg-black text-white hover:bg-white hover:text-black hover:scale-105 cursor-pointer"
                }`}
              >
                Add To Cart
              </button>

  ...
  return (
    <div className="poppins">
      <div
        ...
        <div
          className={`absolute right-0 top-0 h-full w-[420px] bg-white shadow-xl flex flex-col p-8 transform transition-transform duration-500 ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/cart" className="flex-1">
                <button onClick={() => { setIsOpen(false); }} className="w-full py-4 text-sm font-semibold border

...
//                               <FiMinus />
//                             </button>
//                             <span className="font-medium cursor-pointer">{item.quantity}</span>
//                             <button
//                               onClick={() =>
//                                 updateItemQuantity(item.id, item.quantity + 1)
//                               }
...
//                   disabled={loading}
//                   className={`mt-6 px-6 py-3 bg-white text-black hover:bg-gray-100 transition font-medium cursor-pointer ${
